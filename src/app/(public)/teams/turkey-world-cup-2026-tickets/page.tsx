...
export const metadata: Metadata = { title: "Turkey World Cup 2026 Tickets | Ay-Yıldızlılar", description: "Buy Turkey FIFA World Cup 2026 tickets. Watch the Crescent Stars compete in Group G." }

const teamInfo = { name: "Turkey", flag: "🇹🇷", confederation: "UEFA", fifaRanking: 26, group: "G", nickname: "Ay-Yıldızlılar", coach: "Vincenzo Montella", captain: "Hakan Çalhanoğlu" }

const keyPlayers = [
  { name: "Hakan Çalhanoğlu", position: "Midfielder", club: "Inter Milan", number: 10, star: true },
  { name: "Arda Güler", position: "Midfielder", club: "Real Madrid", number: 17 },
  { name: "Kenan Yıldız", position: "Forward", club: "Juventus", number: 11 },
  { name: "Ferdi Kadıoğlu", position: "Defender", club: "Fenerbahçe", number: 2 },
  { name: "Çağlar Söyüncü", position: "Defender", club: "Fenerbahçe", number: 4 },
]

const groupFixtures = [
  { match: "Belgium vs Turkey", date: "June 14, 2026", time: "8:00 PM ET", venue: "Mercedes-Benz Stadium", city: "Atlanta", slug: "belgium-vs-turkey-world-cup-2026-tickets" },
  { match: "Turkey vs Egypt", date: "June 19, 2026", time: "8:00 PM ET", venue: "NRG Stadium", city: "Houston", slug: "turkey-vs-egypt-world-cup-2026-tickets" },
  { match: "Turkey vs TBD", date: "June 24, 2026", time: "8:00 PM ET", venue: "AT&T Stadium", city: "Dallas", slug: "turkey-group-match-3-world-cup-2026-tickets" },
]

const affiliateLinks = [{ partner: "Ticketmaster", price_from: 90, logo: "🎫", url: "#" }, { partner: "StubHub", price_from: 125, logo: "🎟️", url: "#" }]

export default function TurkeyTicketsPage() {
  return (
    <div>
      <section className="relative bg-gradient-to-r from-red-600 via-white to-red-600 py-20">
        ...
        <div className="container relative mx-auto px-4">
          <div className="mt-8 flex items-center gap-4">
            ...
            <div><Badge className="bg-red-600 text-white mb-2">GROUP G</Badge><h1 className="text-4xl font-bold text-slate-900">{teamInfo.name}</h1><p className="text-xl text-slate-700">{teamInfo.nickname}</p></div>
          </div>
          <p className="mt-4 text-lg text-slate-800 max-w-2xl">The Crescent Stars rise! Arda Güler and Kenan Yıldız lead Turkey's golden generation. Remember 2002? Turkey aims to recreate that magic.</p>
          <Button size="lg" className="mt-6 bg-red-600 hover:bg-red-700"><Ticket className="mr-2 h-5 w-5" />Buy Turkey Tickets</Button>
        </div>
      </section>
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-8">
            <Card className="border-yellow-400 bg-yellow-50"><CardContent className="p-6"><h3 className="font-bold text-yellow-900">Golden Generation</h3><p className="text-sm text-yellow-800 mt-2">Real Madrid's Arda Güler and Juventus' Kenan Yıldız form one of the most exciting young attacking duos in world football.</p></CardContent></Card>
            <Card><CardHeader><CardTitle><Calendar className="inline h-5 w-5 mr-2" />Group G Schedule</CardTitle></CardHeader>
