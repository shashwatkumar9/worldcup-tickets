...
export const metadata: Metadata = { title: "Tunisia World Cup 2026 Tickets | Eagles of Carthage", description: "Buy Tunisia FIFA World Cup 2026 tickets. Watch the Eagles of Carthage compete in their 7th World Cup." }

const teamInfo = { name: "Tunisia", flag: "🇹🇳", confederation: "CAF", fifaRanking: 40, group: "TBD", nickname: "Eagles of Carthage", coach: "TBD", captain: "Youssef Msakni" }

const keyPlayers = [
  { name: "Hannibal Mejbri", position: "Midfielder", club: "Manchester United", number: 8, star: true },
  { name: "Youssef Msakni", position: "Forward", club: "Al-Arabi", number: 7 },
  { name: "Aissa Laidouni", position: "Midfielder", club: "Union Berlin", number: 6 },
  { name: "Ellyes Skhiri", position: "Midfielder", club: "Frankfurt", number: 4 },
  { name: "Wahbi Khazri", position: "Forward", club: "Montpellier", number: 10 },
]

const groupFixtures = [
  { match: "Tunisia vs TBD", date: "June 2026", time: "TBD", venue: "TBD", city: "TBD", slug: "tunisia-group-match-1-world-cup-2026-tickets" },
  { match: "Tunisia vs TBD", date: "June 2026", time: "TBD", venue: "TBD", city: "TBD", slug: "tunisia-group-match-2-world-cup-2026-tickets" },
  { match: "Tunisia vs TBD", date: "June 2026", time: "TBD", venue: "TBD", city: "TBD", slug: "tunisia-group-match-3-world-cup-2026-tickets" },
]

const affiliateLinks = [{ partner: "Ticketmaster", price_from: 80, logo: "🎫", url: "#" }, { partner: "StubHub", price_from: 115, logo: "🎟️", url: "#" }]

export default function TunisiaTicketsPage() {
  return (
    <div>
      <section className="relative bg-gradient-to-r from-red-600 via-white to-red-600 py-20">
        ...
        <div className="container relative mx-auto px-4">
          <div className="mt-8 flex items-center gap-4">
            ...
            <div><Badge className="bg-red-600 text-white mb-2">WORLD CUP REGULARS</Badge><h1 className="text-4xl font-bold text-slate-900">Tunisia World Cup 2026 Tickets</h1><p className="text-xl text-slate-700">{teamInfo.nickname}</p></div>
          </div>
          <p className="mt-4 text-lg text-slate-800 max-w-2xl">The Eagles of Carthage soar again! Tunisia's 7th World Cup appearance. They beat France in 2022 - what more can they achieve?</p>
          <Button size="lg" className="mt-6 bg-red-600 hover:bg-red-700"><Ticket className="mr-2 h-5 w-5" />Buy Tunisia Tickets</Button>
        </div>
      </section>
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-8">
            <Card className="border-yellow-400 bg-yellow-50"><CardContent className="p-6"><h3 className="font-bold text-yellow-900">Giant Killers</h3><p className="text-sm text-yellow-800 mt-2">Tunisia shocked France 1-0 at the 2022 World Cup. With rising talent like Hannibal Mejbri, they're ready for more surprises.</p></CardContent></Card>
