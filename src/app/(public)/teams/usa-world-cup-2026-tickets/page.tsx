          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <article className="prose prose-slate max-w-none">
              ...
              <p>
                ...
                <Link href="/teams/australia-world-cup-2026-tickets" className="text-blue-700 hover:underline">Australia World Cup 2026 Tickets</Link>, and a UEFA playoff winner (potentially <Link href="/teams/wales-world-cup-2026-tickets" className="text-blue-700 hover:underline">Wales</Link> or <Link href="/teams/poland-world-cup-2026-tickets" className="text-blue-700 hover:underline">Poland</Link>).
